...
public class BikeTourPlusFeatureSet4Controller {
   ...
   /**
    * Method that updates a specific Guide using their email in the BikeTourPlus system.
    * The Guide is only updated if inputs are valid.
   ...
   /**
    * A method that is used to delete a specific Guide object using an email.
    * Deletes the instance as well as all associations with it.
   ...
   public static void deleteGuide(String email) {
	   ...
	   // if guide with input email exists, we remove them along with any bikeTour associations. Otherwise do nothing
    ...
    * @param email = A string that represents the specific guide's email
    * @return The specific Guide object. If the method doesn't find a match in the Guide list returns a null Guide object
    */
