...
public class BikeTourPlusFeatureSet1Controller {
   ...
   public static String updateManager(String password) {
      ...
      } else {btp.getManager().setPassword("manager");}
   ...
   public static TOBikeTour getBikeTour(int id) {
      ...
      //The ID is indexed in the list rather than following the actual id of the app (could be a mistake :/)
      id -=1;
      ...
      //add an empty array ot TOParticipantCost in order to accomodate differnet costs for each individual person
      ...
      for (int i=0;i < participantsList.size(); i++) {
         ...
         TOParticipantCost  toParticipants = new TOParticipantCost(participantsEmails.get(i), participantsNames.get(i), numberofWeeks*participantcost, numberofWeeks*participantcost+totalCostForGuide);
      ...
      id +=1;
      TOBikeTour tobereturned = new TOBikeTour(id, startWeek, endWeek, guideEmail, guideName, totalCostForGuide, TOParticipantsArray) ;
