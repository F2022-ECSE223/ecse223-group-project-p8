Feature: Register and Update Participant (p1)
  ...
  Scenario Outline: Register a participant successfully
    When a new participant attempts to register with email "<email>", password "<password>", name "<name>", emergency contact "<emergencyContact>", number of weeks "<nrWeeks>", week available from "<weekAvailableFrom>", week available until "<weekAvailableUntil>", and lodge required "<lodgeRequired>" (p1)
    Then a participant account shall exist with email "<email>", password "<password>", name "<name>", emergency contact "<emergencyContact>", number of weeks "<nrWeeks>", week available from "<weekAvailableFrom>", week available until "<weekAvailableUntil>", and lodge required "<lodgeRequired>" (p1)
  ...
  Scenario Outline: Register a participant unsuccessfully
    When a new participant attempts to register with email "<email>", password "<password>", name "<name>", emergency contact "<emergencyContact>", number of weeks "<nrWeeks>", week available from "<weekAvailableFrom>", week available until "<weekAvailableUntil>", and lodge required "<lodgeRequired>" (p1)
    Then a participant account shall not exist with email "<email>", password "<password>", name "<name>", emergency contact "<emergencyContact>", number of weeks "<nrWeeks>", week available from "<weekAvailableFrom>", week available until "<weekAvailableUntil>", and lodge required "<lodgeRequired>" (p1)
  ...
  Scenario Outline: Update a participant account successfully
    When the participant with email "<email>" attempts to update their account information to password "<newPpassword>", name "<newName>", emergency contact "<newEmergencyContact>", number of weeks "<newNrWeeks>", week available from "<newWeekAvailableFrom>", week available until "<newWeekAvailableUntil>", and lodge required "<newLodgeRequired>" (p1)
    Then a participant account shall exist with email "<email>", password "<newPassword>", name "<newName>", emergency contact "<newEmergencyContact>", number of weeks "<newNrWeeks>", week available from "<newWeekAvailableFrom>", week available until "<newWeekAvailableUntil>", and lodge required "<newLodgeRequired>" (p1)
    Then a participant account shall not exist with email "<email>", password "<password>", name "<name>", emergency contact "<emergencyContact>", number of weeks "<nrWeeks>", week available from "<weekAvailableFrom>", week available until "<weekAvailableUntil>", and lodge required "<lodgeRequired>" (p1)
    Then the number of participants shall be "3" (p1)
  ...
  Scenario Outline: Update a participant account unsuccessfully
    When the participant with email "<email>" attempts to update their account information to password "<newPpassword>", name "<newName>", emergency contact "<newEmergencyContact>", number of weeks "<newNrWeeks>", week available from "<newWeekAvailableFrom>", week available until "<newWeekAvailableUntil>", and lodge required "<newLodgeRequired>" (p1)
    Then a participant account shall exist with email "<email>", password "<password>", name "<name>", emergency contact "<emergencyContact>", number of weeks "<nrWeeks>", week available from "<weekAvailableFrom>", week available until "<weekAvailableUntil>", and lodge required "<lodgeRequired>" (p1)
    Then a participant account shall not exist with email "<email>", password "<newPassword>", name "<newName>", emergency contact "<newEmergencyContact>", number of weeks "<newNrWeeks>", week available from "<newWeekAvailableFrom>", week available until "<newWeekAvailableUntil>", and lodge required "<newLodgeRequired>" (p1)
    Then the number of participants shall be "2" (p1)
    Then the system shall raise the error "<error>" (p1)
