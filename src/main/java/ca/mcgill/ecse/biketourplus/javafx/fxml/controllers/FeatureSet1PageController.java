...
public class FeatureSet1PageController {
  ...
  public void initialize() {
    ...
    participantsCol
        .setCellValueFactory(new PropertyValueFactory<TOBikeTourUI, String>("participants"));
    guideTourCost
        .setCellValueFactory(new PropertyValueFactory<TOBikeTourUI, Integer>("guideTourCost"));



    nameCol.setCellValueFactory(
        new PropertyValueFactory<TOParticipantCost, String>("participantName"));
    statusCol.setCellValueFactory(new PropertyValueFactory<TOParticipantCost, String>("status"));
    itemCostCol.setCellValueFactory(
        new PropertyValueFactory<TOParticipantCost, Integer>("totalCostForBookableItems"));
    totalCostCol.setCellValueFactory(
        new PropertyValueFactory<TOParticipantCost, Integer>("totalCostForBikingTour"));
    authCol.setCellValueFactory(
        new PropertyValueFactory<TOParticipantCost, String>("authorizationCode"));
    refundCol.setCellValueFactory(
        new PropertyValueFactory<TOParticipantCost, Integer>("refundedPercentageAmount"));
